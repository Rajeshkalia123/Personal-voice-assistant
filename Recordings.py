...
def Record_Option(option):
    ...
    VideoFile_name = f'C:\J.A.R.V.I.S-main\video file-{time_stamp}.mp4'
    AudioFile_name = f'C:\J.A.R.V.I.S-main\Audio file-{time_stamp}.wav'
    OutputFileName = f'C:\J.A.R.V.I.S-main\video file-{time_stamp}.mp4'
    frames=[]
